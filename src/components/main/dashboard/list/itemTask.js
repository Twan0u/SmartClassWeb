...
class ItemTask extends Component {
    ...
    render() {
        return (
            <tr>
                <ModalTask isUpdate={true} id={this.state.id} title={this.state.title} type={this.state.type}
                           date={this.state.date} visibility={this.state.modalVisible}
                           handleVisibility={this.handleShowModal}/>
                <td width="5%"><i
                    className={this.state.type === 'devoir' ? "fa fa-edit" : this.state.type === 'leçon' ? "fa fa-book" : "fa fa-check"}/>
                </td>
                ...
                <td className="level-right">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a className="button is-small is-info has-background-danger" onClick={this.deleteData}><i
